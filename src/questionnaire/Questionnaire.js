...
export const questionnaireQuestions = [
  ...
  },
  {
    ...
    terms: [
      ...
      {
        id: 'Psychiatrist (medication)',
        value: 'Psychiatrist (medication)',
        label: 'Psychiatrist (medication)',
      },
      {
        id: 'Couples counselor',
        value: 'Couples counselor',
        label: 'Couples counselor',
      },
      ...
      {
        id: 'Premarital counselor',
        value: 'Premarital counselor',
  ...
  },
  {
    ...
    terms: [
      ...
      {
        id: 'College / Young Adult (18 - 26)',
        value: 'College / Young Adult (18 - 26)',
        label: 'College / Young Adult (18 - 26)',
      },
      {
        id: 'Teenager (13 - 17)',
        value: 'Teenager (13 - 17)',
